...
Thank you for your interest in `bacn`, an open source project
administered by StrongLoop.

Contributing to `bacn` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/bacn)
